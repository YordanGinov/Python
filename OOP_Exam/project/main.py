...
# print(manager.add_plant("Flower", "ARose", 15.50, 200, "Spring"))
# print(manager.add_plant("Flower", "ARose", 15.50, 200, "Spring"))
# print(manager.add_plant("Flower", "ARose", 15.50, 200, "Spring"))
# print(manager.add_plant("Flower", "BRose", 15.50, 200, "Spring"))
# print(manager.add_plant("Flower", "BRose", 15.50, 200, "Spring"))
# print(manager.add_plant("Flower", "BRose", 15.50, 200, "Spring"))
#
# manager.add_client("RegularClient", "AAlice Johnson", "1234567890")
# manager.add_client("RegularClient", "BAlice Johnson", "1234567890")
#
# print(manager.sell_plants("1234567890", "ARose", 2))
# print(manager.sell_plants("2234567890", "BRose", 2))
#
# print()
...
# print()
#
# print(manager.add_plant("Flower", "Lily", 1, 10, "Spring"))
# print(manager.add_plant("Flower", "Rose", 1, 10, "Spring"))
#
# # Get shop report
# print(manager.shop_report())
# print()
